...
# Important Window Frame Concept

Sometimes `LAST_VALUE()` behaves unexpectedly because of the default window frame.
...
| Top-N employees | RANK |
| Running sales | SUM |
| Previous transaction | LAG |
| Next transaction | LEAD |
| SCD Processing | ROW_NUMBER |
| Latest CDC Record | ROW_NUMBER |

---

# CDC + Window Functions

Very common enterprise pattern.

## Example — Keep Latest Record Only
