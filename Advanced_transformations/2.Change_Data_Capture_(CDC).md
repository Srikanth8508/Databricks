...
# Real Enterprise CDC Architecture
...
CDC can also be processed continuously using Structured Streaming.
...
This reads only newly changed rows continuously.
...
# CDC Works Only After Enabling

Changes before enabling CDC are not tracked.

---

# CDC Requires Delta Format

CDC works only on:

- Delta Tables

CDC does NOT work on:

- CSV Files
- Plain Parquet Tables
- JSON Files

---

# VACUUM Impact on CDC

If old versions are removed using:
...
- Old CDC history is deleted
- Historical change tracking is lost

---


✅ Efficient enterprise data engineering
